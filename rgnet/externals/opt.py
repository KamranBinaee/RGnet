...
def parse_args():
    ...
    parser.add_argument('--video_file', type=str, default=None, help='The path to the input video file')
    parser.add_argument('--gamma', type=float, default=0.8, help='Gamma value for contrast enhancement')
